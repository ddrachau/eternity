...
public interface AuthenticationClientService {
     ...
     * @return a session cookie and optionally a remember me cookie
     */
    Response loginWithToken(Cookie sessionCookie, Cookie rememberMeCookie, @Context UriInfo uriInfo);
     ...
     */
    Response logout(@Context UriInfo uriInfo, Cookie xsrfCookie, Cookie rememberMeCookie);
